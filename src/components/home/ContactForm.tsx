  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-1">
                    info@alphaflyeducation.com<br />
                    support@alphaflyeducation.com
                  </p>
                </div>
              </div>
        ...
        {/* Map Placeholder */}
        <Card className="bg-white dark:bg-gray-900 border-0 shadow-xl overflow-hidden">
          <div className="h-64 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-500">Click to view location</p>
            </div>
          </div>
        </Card>
      </div>
