            ...
            {sidebarItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <ChevronRight className={`h-4 w-4 ${isActive ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600'}`} />
                </Link>
              );
            })}
          </nav>
          ...
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Manage your learning management system</p>
              </div>
            </div>
...
// Export the AdminLayout for use in other admin pages
export { AdminLayout };